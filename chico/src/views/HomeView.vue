              ...
              <div class="row">
                  <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5" >
                      ...
                      <div class="product-wrap">
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/322.jpg" alt="product-img" /></a>
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/444.jpg" alt="product-img" /></a>
                      </div>
                  ...
                  <div class="product">
                      <div class="product-wrap">
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/111.jpg" alt="product-img" /></a>
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/444.jpg" alt="product-img" /></a>
                      </div>
                  ...
                  <div class="product">
                      <div class="product-wrap">
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/222.jpg" alt="product-img" /></a>
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/322.jpg" alt="product-img" /></a>
                      </div>
                  ...
                  <div class="product">
                      <div class="product-wrap">
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/322.jpg" alt="product-img" /></a>
                          <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/111.jpg" alt="product-img" /></a>
                      </div>
                  ...
                  <div class="product">
                      <div class="product-wrap">
                          <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/444.jpg" alt="product-img" /></a>
                          <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/222.jpg" alt="product-img" /></a>
                      </div>
                  ...
                  <div class="product">
                      <div class="product-wrap">
                          <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/322.jpg" alt="product-img" /></a>
                          <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/222.jpg" alt="product-img" /></a>
                      </div>
                  ...
                  <div class="product">
                      <div class="product-wrap">
                          <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/111.jpg" alt="product-img" /></a>
                          <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/444.jpg" alt="product-img" /></a>
                      </div>
          ...
          <div class="container">
              ...
              <div class="col-lg-4 col-sm-6 col-md-6">
                  ...
                  <h4 class="mb-4 pb-3">Best selllers</h4>
                          ...
                          <div class="media mb-3">
                              ...
                              <img src="src/assets/images/p-2.jpg" alt="Product thumb" width="64" class="img-fluid mr-3" />
                          </a>
                          <div class="media-body">
                          ...
                          <div class="media mb-3">
                          <a class="featured-entry-thumb" href="#">
                              <img src="src/assets/images/p-3.jpg" alt="Product thumb" width="64" class="img-fluid mr-3" />
                          </a>
                          <div class="media-body">
                          ...
                          <div class="media mb-3">
                              <a class="featured-entry-thumb" href="#">
                              <img src="src/assets/images/p-4.jpg" alt="Product thumb" width="64" class="img-fluid mr-3" />
                          </a>
                          <div class="media-body">
                          ...
                          <div class="media">
                              <a class="featured-entry-thumb" href="#">
                              <img src="src/assets/images/p-5.jpg" alt="Product thumb" width="64" class="img-fluid mr-3" />
                          </a>
                          <div class="media-body">
              ...
              <div class="col-lg-4 col-sm-6 col-md-6">
                  ...
                  <h4 class="mb-4 pb-3">New Arrivals</h4>
                          ...
                          <div class="media mb-3">
                              <a class="featured-entry-thumb" href="#">
                              <img src="src/assets/images/p-8.jpg" alt="Product thumb" width="64" class="img-fluid mr-3" />
                          </a>
                          <div class="media-body">
                              <h6 class="featured-entry-title mb-0"><a href="#">Nike - Brasilia Medium Backpack</a></h6>
                              <p class="featured-entry-meta">$27.99</p>
