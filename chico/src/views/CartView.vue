<template>
  <div className="checkout-container">
                            ...
                            <table class="table shop_table shop_table_responsive cart" cellspacing="0">
                                ...
                                <tr class="cart_item">
                                    <td class="product-thumbnail" data-title="Thumbnail">
                                        <a href="/product-single"><img src="src/assets/images/cart-1.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" /></a>
                                    </td>
        ...
        <pre wp-pre-tag-3=""></pre>
                                ...
                                <tr class="cart_item">
                                    <td class="product-thumbnail" data-title="Thumbnail">
                                        <a href="/product-single"><img src="src/assets/images/cart-2.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" /></a>
                                    </td>
                                    <td class="product-name" data-title="Product">
                                        <a href="#">Sunglasses</a>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6" class="actions">
                                        <div class="coupon">
                                            ...
                                            <button type="button" class="btn btn-dark btn-small" name="update_cart" value="Update cart" >Update cart</button>
                                            </span>
                                        </div>
