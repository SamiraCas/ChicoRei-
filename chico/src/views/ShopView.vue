  ...
  <div className="shop-container">
         ...
         <section class="products-shop section">
             ...
             <div class="row">
                 ...
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/322.jpg" alt="product-img" /></a>
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/444.jpg" alt="product-img" /></a>
                 </div>
                 ...
                 <div class="product">
                 <div class="product-wrap">
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/111.jpg" alt="product-img" /></a>
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/444.jpg" alt="product-img" /></a>
                 </div>
                 ...
                 <div class="product">
                 <div class="product-wrap">
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/222.jpg" alt="product-img" /></a>
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/322.jpg" alt="product-img" /></a>
                 </div>
             ...
             <div class="product">
                 <div class="product-wrap">
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/322.jpg" alt="product-img" /></a>
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/111.jpg" alt="product-img" /></a>
                 </div>
                 ...
                 <div class="product">
                 <div class="product-wrap">
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/444.jpg" alt="product-img" /></a>
                 <a href="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/222.jpg" alt="product-img" /></a>
                 </div>
         ...
         <section class="widget widget-popular mb-5">
             ...
             <img src="src/assets/images/p-1.jpg" alt="" class="img-fluid mr-4" />
             ...
             <a class="popular-products-item media" href="/product-single">
             <img src="src/assets/images/p-2.jpg" alt="" class="img-fluid mr-4" />
             <div class="media-body">
             ...
             <a class="popular-products-item media" href="/product-single">
             <img src="src/assets/images/p-3.jpg" alt="" class="img-fluid mr-4" />
             <div class="media-body">
